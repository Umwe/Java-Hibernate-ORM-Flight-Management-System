...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(35, 58, 88));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/flight-hero.jpg"))); // NOI18N
        jLabel4.setText("jLabel4");

        jPanel3.setBackground(new java.awt.Color(39, 69, 88));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(Lgnpassword, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(54, 54, 54)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Btnsignup, loginBtn1});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Btnsignup, loginBtn1});
    ...
    private void loginBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtn1ActionPerformed
                ...
                try {
                    ...
                    SignupInterface service = (SignupInterface) registry.lookup("Signup");
                    List<Signup> userList = service.retrieveuser(email, password);

                    if (emailtxt.getText().trim().isEmpty() || Lgnpassword.getText().trim().isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Please provide all Information", "Fields Empty!", JOptionPane.ERROR_MESSAGE);
                        ...
                        JOptionPane.showMessageDialog(this, "Invalid Email or Password!", "Invalid Credentials", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
